...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference('Like.count') do
      post likes_url, params: { like: { cont: @like.cont, url_curt: @like.url_curt, url_ori: @like.url_ori } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { cont: @like.cont, url_curt: @like.url_curt, url_ori: @like.url_ori } }
